...
class ViTAttnEncoder(nn.Module):
    def __init__(self, arch, checkpoint=None, *args, **kwargs) -> None:
    ...
    ViTHeatmapEncoderOutput = namedtuple(
        "ViTHeatmapEncoderOutput", ["out", "t_length", "attn_weights"]
    )
