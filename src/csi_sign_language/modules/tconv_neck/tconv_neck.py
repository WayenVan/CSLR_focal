from ..components.tconv import TemporalConv1D
...
class TemporalConvNeck(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.tconv = TemporalConv1D(
            in_channels, out_channels, bottle_channels, pooling=pooling, dropout=dropout
        )
    ...
    def forward(self, x, t_length):
        ...
        return self.Ret(out=out, t_length=t_length, feats=feats)
